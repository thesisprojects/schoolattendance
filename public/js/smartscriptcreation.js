...
var app = new Vue({
    ...
    data: {
        ...
        questions: [],
        questionTypes: {},
        valueQuestions: ["Dropdown", "Radio", "Checkbox", 'Select'],
    ...
    computed: {
        questionName: function questionName() {
            return this.questionFormData.name;
        },
        smart_script_question_type_id: function smart_script_question_type_id() {
            return this.questionFormData.smart_script_question_type_id;
        },
        postCodes: function postCodes() {
    ...
    methods: {
        ...
        loadObjections: function loadObjections() {
        ...
        loadQuestionTypes: function loadQuestionTypes() {
        ...
        pushQuestionOption: function pushQuestionOption() {
            var data = {
        ...
        questionOptionIsValid: function questionOptionIsValid(newValue, externalID) {
        ...
        questionOptionRemove: function questionOptionRemove(optionIndex) {
